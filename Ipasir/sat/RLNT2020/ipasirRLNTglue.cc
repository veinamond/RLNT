...
extern "C" {
static const char * sig = "rlnt" VERSION;
...
class IPAsirRLNT : public Solver {
...
public:
  IPAsirRLNT () : szfmap (0), fmap (0), nomodel (false), calls (0) {
...
extern "C" {
#include "ipasir.h"
static IPAsirRLNT * import (void * s) { return (IPAsirRLNT*) s; }
const char * ipasir_signature () { return sig; }
void * ipasir_init () { return new IPAsirRLNT (); }
